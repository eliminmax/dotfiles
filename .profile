...
export PATH="$HOME/.local/bin:$HOME/.cargo/bin:$HOME/.local/pipx/bin:$HOME/.r2env/bin:$clean_path"
unset clean_path
...
if [ -e "$HOME/.config/private_environment" ]; then
    . "$HOME/.config/private_environment"
fi
